...
Author - Amit Gadhave
Date : 19 may 2018
Some changes required here to not solution cases
'''
import time
import Queue
...
#following artay is been used for calculating the child node for given node(Means calculating left, right, top, down swap position in the game)
xd = [-1, 0, 1, 0]
yd = [0, 1, 0, -1]
